...
static void zclGenericApp_Init( void )
{
  ...
  zcl_registerAttrList( GENERICAPP_ENDPOINT, zclGenericApp_NumAttributes, (zclAttrRec_t*)zclGenericApp_Attrs );
  ...
  zcl_registerCmdList( GENERICAPP_ENDPOINT, zclCmdsArraySize, (zclCommandRec_t*)zclGenericApp_Cmds );
#endif
